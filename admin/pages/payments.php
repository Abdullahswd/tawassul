...
<div class="admin-layout">
  ...
  <aside class="sidebar" id="sidebar">
    ...
    <nav class="sidebar-nav">
      ...
      <a href="payments.php" class="nav-item active"><span class="nav-icon">💰</span><span class="nav-label">المدفوعات</span></a>
  ...
  <div class="main-content" id="mainContent">
    <nav class="navbar" id="navbar">
      ...
      <div class="navbar-search"><div style="position:relative"><span style="position:absolute;right:10px;top:50%;transform:translateY(-50%);color:var(--text-secondary)">🔍</span><input type="search" placeholder="بحث في المدفوعات..." style="width:100%;padding:8px 36px 8px 12px;border-radius:10px;background:var(--bg-main);border:1px solid var(--border-color);color:var(--text-primary);font-family:Tajawal,sans-serif;font-size:14px;outline:none" /></div></div>
    ...
    <div class="page-content">
      ...
      <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(220px,1fr));gap:20px;margin-bottom:24px">
        <div class="stat-card animate-fadeInUp delay-1" style="background:linear-gradient(135deg,#10b981,#059669);color:white;border:none">
          ...
          <div class="card-value" style="font-size:30px;color:white" data-counter="84600" data-suffix=" ر.س">0</div>
          <div class="card-label" style="color:rgba(255,255,255,0.8)">إجمالي الأرباح</div>
          <div class="card-trend up" style="color:rgba(255,255,255,0.9)">▲ 22.1% من الشهر الماضي</div>
        </div>
        <div class="stat-card animate-fadeInUp delay-2" style="padding:22px">
          <div style="display:flex;align-items:center;justify-content:space-between">
            <div><div class="card-value" style="font-size:26px" data-counter="1496">0</div><div class="card-label">عدد العمليات</div></div>
        ...
        <div class="stat-card animate-fadeInUp delay-3" style="padding:22px">
          <div style="display:flex;align-items:center;justify-content:space-between">
            <div><div class="card-value" style="font-size:26px" data-counter="12600" data-suffix=" ر.س">0</div><div class="card-label">مدفوعات معلقة</div></div>
        ...
        <div class="stat-card animate-fadeInUp delay-4" style="padding:22px">
          <div style="display:flex;align-items:center;justify-content:space-between">
            <div><div class="card-value" style="font-size:26px" data-counter="3200" data-suffix=" ر.س">0</div><div class="card-label">مدفوعات فاشلة</div></div>
      ...
      <div class="chart-card animate-fadeInUp delay-2" style="margin-bottom:24px">
        <div class="chart-header">
          ...
          <div style="text-align:left">
            <div style="font-size:28px;font-weight:900;color:var(--success)">84,600 ر.س</div>
      ...
      <div class="table-container animate-fadeInUp delay-3">
        ...
        <div style="padding:16px 24px;background:var(--bg-main);border-top:1px solid var(--border-color);display:flex;justify-content:space-between;align-items:center;flex-wrap:wrap;gap:12px">
          <div style="font-size:13px;color:var(--text-secondary)">عرض 1-5 من <strong>1,496</strong> عملية</div>
          <div style="display:flex;gap:24px">
            <div style="text-align:center"><div style="font-size:13px;color:var(--text-secondary)">إجمالي المبالغ</div><div style="font-size:18px;font-weight:800;color:var(--success)">3,295 ر.س</div></div>
            <div style="text-align:center"><div style="font-size:13px;color:var(--text-secondary)">العمليات الناجحة</div><div style="font-size:18px;font-weight:800;color:var(--primary)">3</div></div>
            <div style="text-align:center"><div style="font-size:13px;color:var(--text-secondary)">العمليات الفاشلة</div><div style="font-size:18px;font-weight:800;color:var(--danger)">1</div></div>
          </div>
