        ...
        <div>
          ...
          <div id="section-notifications" class="settings-section" style="display:none">
            <div class="stat-card animate-fadeInUp" style="padding:24px">
              ...
              <div style="border:1px solid var(--border-color);border-radius:14px;overflow:hidden">
                <div style="display:flex;justify-content:space-between;align-items:center;padding:16px 20px;border-bottom:1px solid var(--border-color)"><div><div style="font-size:14px;font-weight:600;color:var(--text-primary)">إشعارات الطلبات الجديدة</div><div style="font-size:12px;color:var(--text-secondary)">تنبيه عند وصول طلب جديد</div></div><label class="toggle-switch"><input type="checkbox" id="notify_new_order" <?= $notify_new_order == '1' ? 'checked' : '' ?> /><span class="toggle-slider"></span></label></div>
                <div style="display:flex;justify-content:space-between;align-items:center;padding:16px 20px;border-bottom:1px solid var(--border-color)"><div><div style="font-size:14px;font-weight:600;color:var(--text-primary)">إشعارات الدفعات</div><div style="font-size:12px;color:var(--text-secondary)">تنبيه عند اكتمال دفعة</div></div><label class="toggle-switch"><input type="checkbox" id="notify_payment" <?= $notify_payment == '1' ? 'checked' : '' ?> /><span class="toggle-slider"></span></label></div>
                <div style="display:flex;justify-content:space-between;align-items:center;padding:16px 20px;border-bottom:1px solid var(--border-color)"><div><div style="font-size:14px;font-weight:600;color:var(--text-primary)">بريد يومي ملخص</div><div style="font-size:12px;color:var(--text-secondary)">تقرير يومي بالنشاط</div></div><label class="toggle-switch"><input type="checkbox" id="daily_summary_email" <?= $daily_summary_email == '1' ? 'checked' : '' ?> /><span class="toggle-slider"></span></label></div>
                <div style="display:flex;justify-content:space-between;align-items:center;padding:16px 20px"><div><div style="font-size:14px;font-weight:600;color:var(--text-primary)">إشعارات تسجيل الأكاديميين</div><div style="font-size:12px;color:var(--text-secondary)">تنبيه عند تسجيل أكاديمي جديد</div></div><label class="toggle-switch"><input type="checkbox" id="notify_new_academic" <?= $notify_new_academic == '1' ? 'checked' : '' ?> /><span class="toggle-slider"></span></label></div>
              </div>
            </div>
          </div>
            ...
            <div class="stat-card animate-fadeInUp" style="padding:24px">
              ...
              <div style="display:flex;flex-direction:column;gap:16px">
                <div style="padding:20px;border:1px solid var(--border-color);border-radius:14px;display:flex;justify-content:space-between;align-items:center">
                  <div style="display:flex;align-items:center;gap:14px"><div style="font-size:32px">💠</div><div><div style="font-size:15px;font-weight:700">Stripe</div><div style="font-size:12px;color:var(--text-secondary)">بوابة دفع دولية</div></div></div>
                ...
                <div style="padding:20px;border:1px solid var(--border-color);border-radius:14px;display:flex;justify-content:space-between;align-items:center">
                  <div style="display:flex;align-items:center;gap:14px"><div style="font-size:32px">🟢</div><div><div style="font-size:15px;font-weight:700">Moyasar</div><div style="font-size:12px;color:var(--text-secondary)">بوابة دفع سعودية</div></div></div>
                ...
                <div style="padding:20px;border:1px solid var(--border-color);border-radius:14px;display:flex;justify-content:space-between;align-items:center">
                  <div style="display:flex;align-items:center;gap:14px"><div style="font-size:32px">🔵</div><div><div style="font-size:15px;font-weight:700">PayPal</div><div style="font-size:12px;color:var(--text-secondary)">بوابة دفع عالمية</div></div></div>
