...
<div class="page-layout">
  ...
  <aside class="sidebar" id="sidebar">
    ...
    <nav class="sidebar-nav">
      ...
      <a href="academic-settings.php" class="nav-item active"><span class="nav-icon">⚙️</span><span class="nav-text">الإعدادات</span></a>
    ...
    <nav class="navbar" id="navbar">
      ...
      <div class="navbar-actions">
        ...
        <div class="dropdown">
          ...
          <div class="dropdown-menu" style="right:0;left:auto;min-width:180px"><div style="padding:8px"><a href="#" class="dropdown-item" style="border-radius:8px;color:var(--danger)">🚪 خروج</a></div></div>
        </div>
      </div>
    </nav>
