  ...
  <div class="navbar-actions">
    ...
    <div class="dropdown" id="profileDropdown">
      <div class="admin-avatar-btn" data-toggle>
        <div class="avatar-circle" id="navAvatarCircle">م</div>
        <div>
          <div class="avatar-name" id="navAvatarName">د. محمد السعيد</div>
...
<!--
  Script: markAllRead is defined here, called by button above.
  main.js handles: DarkMode, AcademicSidebar, renderNotifications
-->
<script>
function markAllRead() {
  if (window.ACADEMICS_DATA) {
    ACADEMICS_DATA.notifications.forEach(n => n.read = true);
    const badge = document.getElementById('notifBadge');
    if (badge) badge.textContent = '0';
    renderNotifications?.();
    Toast?.show('تم تعليم جميع الإشعارات كمقروءة', 'success');
  }
}
</script>
