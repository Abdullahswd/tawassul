            ...
            <form id="multiOrderForm">
              ...
              <div class="form-step" id="step1">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-input" placeholder="مثال: إدارة الموارد البشرية" required>
                </div>
              ...
              <div class="form-step" id="step3" style="display:none">
                ...
                <div class="form-group">
                  ...
                  <textarea class="form-input" rows="5" placeholder="أدخل متطلبات الطلب بالتفصيل لتسهيل فهم الأكاديمي..." required></textarea>
                </div>
          ...
          <div>
            <div class="card" style="position:sticky;top:90px">
              ...
              <div style="margin-top:20px;border-top:1px dashed var(--border-color);padding-top:16px;display:flex;justify-content:space-between;align-items:center">
                ...
                <span id="totalPrice" style="font-size:24px;font-weight:800;color:var(--primary)">0 ر.س</span>
              </div>
